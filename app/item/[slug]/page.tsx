        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {item.enrichment?.status === 'COMPLETED' && item.enrichment.practicalDescription && (
              <Card>
                <h2 className="font-semibold text-lg mb-2">Come funziona</h2>
            ...
            {item.enrichment?.status === 'COMPLETED' && item.enrichment.useCase && (
              <div className="rounded-xl border border-indigo-500/20 bg-gradient-to-br from-indigo-500/5 via-purple-500/5 to-transparent dark:from-indigo-500/[0.07] dark:via-purple-500/[0.05] p-6">
                <div className="flex items-center gap-2.5 mb-4">
                  ...
                  <h2 className="font-semibold text-lg">Come usarlo nel tuo workflow</h2>
                </div>
                ...
                <div className="mt-4 flex items-center gap-2 text-xs text-indigo-400">
                  ...
                  Scenario generato con AI per aiutarti a valutare lo strumento
                </div>
              </div>
            )}
