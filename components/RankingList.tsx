...
interface Props {
  ...
  currentEnriched: boolean;
}

export function RankingList({ rankings, totalCount, currentPage, totalPages, currentType, currentSearch, currentEnriched }: Props) {
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="flex gap-1.5 flex-wrap">
          ...
          {/* AI Enriched toggle */}
          <button
            onClick={() => navigate({ enriched: currentEnriched ? undefined : '1' })}
